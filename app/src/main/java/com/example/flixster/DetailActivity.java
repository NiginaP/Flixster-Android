...
public class DetailActivity extends YouTubeBaseActivity {
    private static final String YOUTUBE_API = "AIzaSyD9XXyxtmtIXmCong_hsg2u3HzI5HUGntU";
        ...
        client.get(String.format(VIDEO_URL, movie.getMovieId()), new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                try {
                    ...
                    Log.e("DetailActivity", "Youtube Key:" + youtubeKey);
                    initializeYoutube(youtubeKey);

                } catch (JSONException e) {
                    Log.e("DetailActivity", "Failed to parse trailer url.");
                }
            }
    ...
    private void initializeYoutube(final String youtubeKey) {
        youtubePlayer.initialize(YOUTUBE_API, new YouTubePlayer.OnInitializedListener() {
            @Override
